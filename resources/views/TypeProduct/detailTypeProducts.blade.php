         ...
         ">
                ...
                <div class="container-fluid g-0 m-auto"
                    ...
                    <menu
                        ...
                        <div class="card-group-menu-active p-2 card-menu-items d-flex justify-content-center flex-nowrap flex-column"
                    ...
                    <div class="filter-groups d-flex justify-content-start align-items-center gap-3 p-3 ps-4 px-4"
                        ...
                        <div class="filter-groups-item position-relative">
                            ...
                            <span class="position-absolute top-0 start-0 translate-middle badge rounded-pill"
                                style="background: #ecd60f; color: black; font-weight: bold">
                                99+
                            </span>
                        </div>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu p-0" aria-labelledby="dropdownMenuButton2">
                                    <ul style="list-style-type: none; width: 400px"
                                        class="p-0 m-0 g-0 d-flex justify-content-start flex-nowrap align-items-center">
                                        <li style="width: 100px; height: auto">
                                            <a class="dropdown-item" href="#">
                                                <img style="width: 100%"
                                                    src="../folderImages/images/brand/dalat-milk-05092023143114.png"
                                                    alt="" />
                                            </a>
                                        </li>
                                        <li style="width: 100px; height: auto">
                                            <a class="dropdown-item" href="#">
                                                <img style="width: 100%"
                                                    src="../folderImages/images/brand/felce-azzurra-0506202113525.png"
                                                    alt="" />
                                            </a>
                                        </li>
                                        <li style="width: 100px; height: auto">
                                            <a class="dropdown-item" href="#">
                                                <img style="width: 100%"
                                                    src="../folderImages/images/brand/meadow-fresh-03082022162948.png"
                                                    alt="" />
                                            </a>
                                        </li>
                                    </ul>
