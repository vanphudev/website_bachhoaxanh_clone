...
@section('content')
    <div id="popup_Login_show" class="menu-fixed-hover container-fluid g-0 m-auto pt-2" style="
   width: 100%;
   height: 100vh;
   display: none;
   position: fixed;
...
">
      ...
      ">
            ...
            <div class="g-0 text-center" style="
    ...
    <main class="container-fluid g-0 m-auto" style="width: calc(var(--width-menu) * 2 + var(--width-search)); padding-top: 105.5px">
            ...
            <div class="g-0 p-0" style="width: var(--width-menu); height: 100vh; position: fixed; top: 0px; z-index: 99999">
               ...
               ">
                            <h2 class="accordion-header" id="heading1">
                                <div style="color: #469c4b; background: transparent" class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                                    Accordion Item #1
                                </div>
                            </h2>
               ...
               ">
                            <h2 class="accordion-header" id="heading2">
                                <div style="color: #469c4b; background: transparent" class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="true" aria-controls="collapse2">
                                    Accordion Item #1
                                </div>
                            </h2>
      ...
      ">
         ...
         ">
                ...
                <div class="container-fluid g-0 m-auto mt-3" style="
            width: calc(var(--width-menu) + var(--width-search) - var(--margin-left));
            background: var(--bgcolor-white);
            border-radius: 10px;
         ">
                    ...
                    <menu class="card-group-menu-with-type-search g-0 mt-2 p-2 d-flex justify-content-start flex-nowrap align-items-center gap-2" style="background: var(--bgcolor-white); border-radius: 10px; width: 100%">
                     ...
                     ">Rau,
                        ...
                        <div class="stretched-link-taga p-2 card-menu-items-search d-flex justify-content-center flex-nowrap flex-column" style="width: calc((var(--width-menu) + var(--width-search) - var(--margin-left)) / 12)">
                            <div class="card-menu-img-top m-auto d-flex justify-content-center align-items-center" style="width: 100%; height: 70px; overflow: hidden">
                    ...
                    <div class="filter-groups d-flex justify-content-start align-items-center gap-3 p-3 ps-4 px-4" style="background: var(--bgcolor-white); border-radius: 10px; width: 100%">
                        ...
                        <div class="filter-groups-brands p-1 d-flex justify-content-start flex-nowrap align-items-center" style="width: 950px">
                            <div class="filter-groups-brand-item mx-2 object-fit-contain p-2" style="height: 90px">
                                <img src="../folderImages/images/brand/dalat-milk-05092023143114.png" alt="Thương hiệu 01" style="width: 100%; height: 100%" />
                            </div>
                            <div class="filter-groups-brand-item mx-2 object-fit-contain p-2" style="height: 90px">
                                <img src="../folderImages/images/brand/ensure-13032023112110.png" alt="Thương hiệu 01" style="width: 100%; height: 100%" />
                            </div>
                            <div class="filter-groups-brand-item mx-2 object-fit-contain p-2" style="height: 90px">
                                <img src="../folderImages/images/brand/felce-azzurra-0506202113525.png" alt="Thương hiệu 01" style="width: 100%; height: 100%" />
                            </div>
                            <div class="filter-groups-brand-item mx-2 object-fit-contain p-2" style="height: 90px">
                                <img src="../folderImages/images/brand/meadow-fresh-03082022162948.png" alt="Thương hiệu 01" style="width: 100%; height: 100%" />
                            </div>
                            <div class="filter-groups-brand-item mx-2 object-fit-contain p-2" style="height: 90px">
                                <img src="../folderImages/images/brand/optimum-15032021101124.png" alt="Thương hiệu 01" style="width: 100%; height: 100%" />
                            </div>
                            <div class="filter-groups-brand-item mx-2 object-fit-contain p-2" style="height: 90px">
                                <img src="../folderImages/images/brand/romano-04042021185335.png" alt="Thương hiệu 01" style="width: 100%; height: 100%" />
                            </div>
                            <div class="filter-groups-brand-item mx-2 object-fit-contain p-2" style="height: 90px">
                                <img src="../folderImages/images/brand/some-by-mi-010420229169.png" alt="Thương hiệu 01" style="width: 100%; height: 100%" />
                            </div>
                            <div class="filter-groups-brand-item mx-2 object-fit-contain p-2" style="height: 90px">
                                <img src="../folderImages/images/brand/vaseline-04042021225515.png" alt="Thương hiệu 01" style="width: 100%; height: 100%" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container-fluid g-0 m-auto mt-3 position-relative" style="
            width: calc(var(--width-menu) + var(--width-search) - var(--margin-left));
            background: var(--bgcolor-white);
            border-radius: 8px;
         ">
                            ...
                            <div class="slider-card-group-item-inf g-0 p-0 position-relative">
                                <div class="slider-card-group-item-top d-flex flex-column justify-content-center">
                                    <div class="slider-card-group-item-img m-auto d-flex justify-content-center align-items-center" style="width: 100%; height: 211px; overflow: hidden">
                                        <img class="object-fit-contain" src="../images/product/sanpham2.png" alt="" style="width: 100%; height: auto" />
                                    </div>
